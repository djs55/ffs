...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2c3de9e2da96d7c9c389db180d7b486e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["David Scott <dave.scott@citrix.com>"];
          homepage = None;
          synopsis = "Flat FileSystem xapi storage driver";
          description = None;
          categories = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("vhd-format",
                               Some (OASISVersion.VGreaterEqual "0.7.2"));
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\255\206\005{\2556\026\012\213}\2062|\163VG";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
